...
export function openCoachSheet(opts = {}) {
  ...
  function runNow(id, label, said) {
    ...
    // weekly volume?", once in four weeks; v56, where a custom exercise's
    // movement is set, under "Is my training balanced?") is stamped as it is
    // drawn, the way a question is when it is put.
